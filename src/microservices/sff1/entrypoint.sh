...
/tmp/sff1_dpdk -l $DPDK_CORE -m 256 --file-prefix=sff1 --single-file-segments --no-pci \
  --vdev=net_virtio_user0,path=/tmp/vh-sff1-cam,server=1,queue_size=4096,mac=00:00:00:00:01:02 \
  --vdev=net_virtio_user1,path=/tmp/vh-sff1-sff2,server=1,queue_size=1024,mac=00:00:00:00:02:01 \
  --log-level=*:alert